...
export const metadata: Metadata = {
    title: 'About Us - MSME Registered Import Export Company',
    description: 'Learn about AOA Import Export, an MSME-registered company in India providing reliable international trade solutions with integrity, quality, compliance, and reliability.',
    keywords: ['About AOA', 'MSME import export company', 'International trade India', 'Company history', 'Mission vision values'],
    openGraph: {
        title: 'About AOA - MSME Registered Import Export Company',
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        "mainEntity": {
                            ...
                            "foundingDate": "2025",
                            "description": "MSME-registered import and export company specializing in comprehensive international trade solutions",
                            ...
                            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20 shadow-2xl">
                                <div className="grid grid-cols-2 gap-6 text-center">
                                    <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                                        <div className="text-3xl font-bold text-white mb-2">MSME</div>
                                        <div className="text-white/80 text-sm">Government Registered</div>
                                    </div>
                                    <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
                                MSME-Registered Excellence in Global Trade
                            </h2>
                            <div className="space-y-4 text-gray-600 leading-relaxed">
                                <p>
                                    AOA Import Export is a government-registered MSME (Micro, Small & Medium Enterprise)
                                    company based in India, specializing in comprehensive international trade solutions.
                                    Our MSME registration not only validates our credibility but also provides our
                                    clients with access to special trade benefits and government support schemes.
                                </p>
                                <p>
                                    Founded with a vision to bridge the gap between Indian businesses and global markets,
                                    we have established ourselves as a reliable partner for companies seeking to expand
                                    their international footprint. Our expertise spans across import services, export
                                    facilitation, global sourcing, and end-to-end logistics support.
                                </p>
                                <p>
                                    With our deep understanding of international trade regulations, customs procedures,
                                    and market dynamics across Asia, Middle East, Europe, and Africa, we ensure seamless
                                    and compliant trade operations for our valued partners.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-lg">
                            ...
                            <p className="text-gray-600 leading-relaxed mb-6">
                                To empower Indian businesses with seamless access to global markets through
                                comprehensive import-export solutions, while maintaining the highest standards
                                of compliance, quality, and customer service. We are committed to fostering
                                international trade relationships that drive mutual growth and prosperity.
                            </p>
                            <ul className="space-y-2 text-gray-600">
                                <li className="flex items-start">
                                    ...
                                    Facilitate seamless international trade
                                </li>
                                <li className="flex items-start">
                                    <svg className="w-5 h-5 text-[#1E40AF] mr-2 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                        ...
                        <div className="bg-[#0F2A44] text-white rounded-2xl p-8 shadow-lg">
                            ...
                            <p className="text-blue-100 leading-relaxed mb-6">
                                To become India's most trusted and preferred MSME partner for international
                                trade, recognized globally for our expertise, integrity, and innovative
                                solutions. We envision a future where geographical boundaries do not limit
                                business growth, and every enterprise can access global opportunities with confidence.
                            </p>
                            <ul className="space-y-2 text-blue-100">
                                <li className="flex items-start">
                                    ...
                                    Leading MSME trade facilitator in India
                                </li>
                                <li className="flex items-start">
                                    <svg className="w-5 h-5 text-white mr-2 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
            ...
            <section className="py-16 lg:py-24 bg-[#0F2A44] text-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
                        Partner with AOA Import Export and leverage our MSME-registered expertise
                        to unlock new international opportunities for your business.
                    </p>
